...
class MYPROJECTEDITOR_API UBPNode_CreateGameplayEffect : public UK2Node_ConstructObjectFromClass
{
	...
	void					GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const override; //Changes certain things but needs to have call to super function to see it in the node browser
