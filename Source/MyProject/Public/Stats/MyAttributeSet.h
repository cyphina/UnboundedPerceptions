...
public:
	...
	TArray<FGameplayAttributeData*> GetAtts();
	TArray<FGameplayAttributeData*> GetSkills();
	TArray<FGameplayAttributeData*> GetVitals();
	TArray<FGameplayAttributeData*> GetMechanics();
