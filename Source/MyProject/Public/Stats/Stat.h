...
namespace CombatInfo
{
   ...
   struct ModifyingAttribute {
      ...
      ModifyingAttribute(FGameplayAttributeData* att) : attribute(att) { effectRatio = nullptr; }

      ModifyingAttribute(FGameplayAttributeData* att, EFF eff) : attribute(att) { effectRatio = eff; }
   };
