...
class MYPROJECT_API UDamageCalculation : public UGameplayEffectExecutionCalculation
{
 ...
 private:
   ...
   // Damage calculation on receiving end, and possibly dodge check since accuracy is completely calculated at this step. Dodge check at beginning would help optimize, but true accuracy value isn't
   // known Public since AUnit declares this as a friend function so we can access the setter methods for change stats
