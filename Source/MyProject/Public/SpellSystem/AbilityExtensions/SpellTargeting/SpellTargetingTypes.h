...
public:
   ...
   virtual void AdjustCastPosition(USpellCastComponent* spellCastComp, TSubclassOf<UMySpell> spellClass, UTargetComponent* targetComp) const PURE_VIRTUAL(UUpSpellTargeting::AdjustCastPosition, );
   ...
   virtual UEnvQuery* GetDefaultQueryForTargetingScheme(UDA_DefaultTargetingScheme* targetingSchemes) const PURE_VIRTUAL(UUpSpellTargeting::GetDefaultQueryForTargetingScheme, return nullptr; );

   virtual void HandleQueryResult
   (TSharedPtr<FEnvQueryResult> result, AUnit* casterRef, USpellCastComponent* spellCastComponent,
    TSubclassOf<UMySpell>       spellToCast) const PURE_VIRTUAL(UUpSpellTargeting::HandleQueryResult, );
