...
struct FUpSpellTargeting_Vector;
struct FUpSpellTargeting_Area;
struct FUpSpellTargeting_SingleUnit;
struct FUpSpellTargeting_None;
...
class MYPROJECT_API USpellDataManager : public UObject
{
 ...
 private:
   ...
   const FUpSpellTargeting* MakeSpellTargeting(FGameplayTag targetTag);
