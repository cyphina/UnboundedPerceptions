...
{
   static const inline FName AIMessage_SpellCasted    = TEXT("SpellCasted!"); // After spell casted succesffully
   static const inline FName AIMessage_SpellCastFail    = TEXT("SpellCastFailed!"); // When AI searches for a target and finds one but maybe the target turns invunlnerable during cast
   ...
   static const inline FName AIMessage_ActionFinished    = TEXT("ActionFinished");
};
