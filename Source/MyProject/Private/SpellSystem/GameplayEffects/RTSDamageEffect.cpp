...
URTSDamageEffect::URTSDamageEffect()
{
   ...
   modifierInfo.CapturedAttribute.AttributeToCapture = UMyAttributeSet::GetStrengthAttribute();
   ...
   modifierInfo2.CapturedAttribute.AttributeToCapture = UMyAttributeSet::GetIntelligenceAttribute();
   ...
   modifierInfo3.CapturedAttribute.AttributeToCapture = UMyAttributeSet::GetAgilityAttribute();
   ...
   modifierInfo4.CapturedAttribute.AttributeToCapture = UMyAttributeSet::GetUnderstandingAttribute();
   ...
   modifierInfo5.CapturedAttribute.AttributeToCapture = UMyAttributeSet::GetHealthAttribute();
