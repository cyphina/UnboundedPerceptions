...
#define LOCTEXT_NAMESPACE "SettingsMenuCategories"
	...
	resolutionCategories = {LOCTEXT("Resolution1","1920x1080"), 
							LOCTEXT("Resolution2","1600x900"),
							LOCTEXT("Resolution3","1366x768"),					
							LOCTEXT("Resolution4","1024x768"),
							LOCTEXT("Resolution5","800x600")
	};
	qualityCategories = {	LOCTEXT("Quality1","Low"),
							LOCTEXT("Quality2","Medium"),
							LOCTEXT("Quality3","High"),
							LOCTEXT("Quality4","Epic"),
							LOCTEXT("Quality5","Cinematic")
	};
	fPSCategories = {		LOCTEXT("FPS1","30"),
							LOCTEXT("FPS2","60"),
							LOCTEXT("FPS3","90"),
							LOCTEXT("FPS4","120"),
							LOCTEXT("FPS5","200"),
							LOCTEXT("FPS6","Unlimited")
	};
