...
#endif
			if(!currentlyStoredEffectsList.HasTagExact(nameTag)) //if we don't have this effect already (checked since we can have multiple effects with same name since effect parts have to be split...)
			{
