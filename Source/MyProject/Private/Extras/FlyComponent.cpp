...
UFlyComponent::UFlyComponent()
{
   ...
   if (owner) { owner->GetCapsuleComponent()->OnComponentBeginOverlap.AddDynamic(this, &UFlyComponent::OnFlightBoxColliderOverlap); }
   // ...
}
...
void UFlyComponent::OnFlightBoxColliderOverlap(UPrimitiveComponent* overlappedComponent, AActor* otherActor, UPrimitiveComponent* otherComp, int32 otherBodyIndex, bool bFromSweep,
